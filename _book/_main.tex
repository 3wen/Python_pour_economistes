...
\NormalTok{plt.plot(x, y_2, color}\OperatorTok{=}\StringTok{"#00FF00"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{x }\OperatorTok{=}\NormalTok{ np.random.randn(}\DecValTok{1000}\NormalTok{)}
\NormalTok{plt.hist(x, color }\OperatorTok{=} \StringTok{"#00FF00"}\NormalTok{, edgecolor}\OperatorTok{=}\StringTok{'black'}\NormalTok{, linewidth}\OperatorTok{=}\FloatTok{1.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
