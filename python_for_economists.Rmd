...
Table: Valeurs principales pour la manière d'ouvrir les fichiers.
...
with open(path, "r") as mon_fichier:
  donnees = fonction_pour_recuperer_donnees_depuis_f()
```
...
La méthode `reader()` peut prendre plusieurs paramètres, parmi lesquels :
